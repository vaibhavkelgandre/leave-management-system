...
>
> **391 server tests** across 39 files (integration-level, against a real Postgres schema) and **434 client
> tests** across 63 files. Both run from a single `npm test` at the repository root.
